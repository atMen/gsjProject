 ...
 * date: 2017/9/27 .
 */
public class ldjhAdapter extends BaseQuickAdapter<qyListInfo.DataBean.ContentBean, BaseViewHolder> {
    private Context mContext;

    public ldjhAdapter(@Nullable List<qyListInfo.DataBean.ContentBean> data, Context context) {
