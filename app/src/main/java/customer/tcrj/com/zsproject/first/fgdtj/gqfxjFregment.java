...
import customer.tcrj.com.zsproject.adapter.xjDropMenuAdapter;
...
public class gqfxjFregment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, OnFilterDoneListener {
...
//    }
    ...
    private void initFilterDropDownView() {
        String[] titleList = new String[] { "请选择县级"};
        dropDownMenu.setMenuAdapter(new xjDropMenuAdapter(mContext, titleList, this));
    }
