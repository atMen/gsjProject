...
public class gqfFregment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, OnFilterDoneListener {
...
//    }
    ...
    private void initFilterDropDownView() {
        ...
        dropDownMenu.setMenuAdapter(new DropMenuAdapter(mContext, titleList, this));
    }

    @Override public void onFilterDone(int position, String positionTitle, String urlValue) {
        Log.e("TAG","positionTitle:"+positionTitle+"urlValue:"+urlValue);
        if (position != 3) {
