 ...
 * date: 2017/9/27 .
 */
public class pxfwAdapter extends BaseQuickAdapter<qyListInfo.DataBean.ContentBean, BaseViewHolder> {
    private Context mContext;

    public pxfwAdapter(@Nullable List<qyListInfo.DataBean.ContentBean> data, Context context) {
