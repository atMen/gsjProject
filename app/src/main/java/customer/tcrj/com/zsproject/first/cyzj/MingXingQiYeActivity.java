...
import customer.tcrj.com.zsproject.first.zcgs.cyxqActivity;
import customer.tcrj.com.zsproject.widget.CustomLoadMoreView;
import in.srain.cube.views.ptr.PtrDefaultHandler;
import in.srain.cube.views.ptr.PtrFrameLayout;
import in.srain.cube.views.ptr.PtrHandler;

public class MingXingQiYeActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener {
...
//}
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        toClass(this,cyxqActivity.class);//创业
