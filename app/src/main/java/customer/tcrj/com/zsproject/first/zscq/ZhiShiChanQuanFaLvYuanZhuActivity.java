...
import customer.tcrj.com.zsproject.adapter.zscqflyzAdapter;
import customer.tcrj.com.zsproject.base.BaseActivity;
import customer.tcrj.com.zsproject.base.dialogActivity;
import customer.tcrj.com.zsproject.bean.jdInfo;
import customer.tcrj.com.zsproject.first.zcgs.yhActivity;
import customer.tcrj.com.zsproject.widget.CustomLoadMoreView;
import in.srain.cube.views.ptr.PtrDefaultHandler;
import in.srain.cube.views.ptr.PtrFrameLayout;
import in.srain.cube.views.ptr.PtrHandler;

public class ZhiShiChanQuanFaLvYuanZhuActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener{
    ...
    private zscqflyzAdapter detailAdapter;
    ...
    protected int setLayout() {
        return R.layout.activity_zscqflyz;
    }
    ...
    protected void setView() {
        ...
        for (int i = 0;i < 10;i++){
            jdInfo.ContentBean bean = new jdInfo.ContentBean();
            beanList.add(bean);
        }

        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mRecyclerView.setAdapter(detailAdapter = new zscqflyzAdapter(beanList, this));
...
//                Toast.makeText(flfgListActivity.this, getResources().getString(R.string.data_failed), Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        toClass(this,ZhiShiChanQuanFaLvYuanZhuInfoActivity.class);
    }
