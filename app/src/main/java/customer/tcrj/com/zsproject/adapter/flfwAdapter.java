 ...
 * date: 2017/9/27 .
 */
public class flfwAdapter extends BaseQuickAdapter<qyListInfo.DataBean.ContentBean, BaseViewHolder> {
    private Context mContext;

    public flfwAdapter(@Nullable List<qyListInfo.DataBean.ContentBean> data, Context context) {
