 ...
 * date: 2017/9/27 .
 */
public class fpdxAdapter extends BaseQuickAdapter<qyListInfo.DataBean.ContentBean, BaseViewHolder> {
    private Context mContext;

    public fpdxAdapter(@Nullable List<qyListInfo.DataBean.ContentBean> data, Context context) {
        super(R.layout.item_fpdx, data);
