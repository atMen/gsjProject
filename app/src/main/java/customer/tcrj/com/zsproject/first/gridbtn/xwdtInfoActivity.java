...
public class xwdtInfoActivity extends BaseActivity implements View.OnClickListener {
...
//        mViewPager.setOffscreenPageLimit(4);
        myFragmentPagerAdapter = new xwdtFragmentPagerAdapter(getSupportFragmentManager());
