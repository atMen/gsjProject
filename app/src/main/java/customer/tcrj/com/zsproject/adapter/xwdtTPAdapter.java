 ...
 * date: 2017/9/27 .
 */
public class xwdtTPAdapter extends BaseQuickAdapter<qyListInfo.DataBean.ContentBean, BaseViewHolder> {
    private Context mContext;

    public xwdtTPAdapter(@Nullable List<qyListInfo.DataBean.ContentBean> data, Context context) {
