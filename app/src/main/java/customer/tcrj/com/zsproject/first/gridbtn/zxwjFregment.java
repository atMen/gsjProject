...
import customer.tcrj.com.zsproject.adapter.xwdtTPAdapter;
...
public class zxwjFregment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {
...
//    public TextView title_tv;
    ...
    @BindView(R.id.tv_gwywj)
    TextView tv_gwywj;
    @BindView(R.id.tv_gwyzcbm)
    TextView tv_gwyzcbm;
...
//        showSuccess();
    ...
    private void getData(final int num) {
        ...
        try {
            ...
            if(type == 0){
                jsonObject.put("id", ApiConstants.ZXWJ1);
            }else {
                jsonObject.put("id", ApiConstants.ZXWJ2);
            }
...
//                Toast.makeText(flfgListActivity.this, getResources().getString(R.string.data_failed), Toast.LENGTH_SHORT).show();
    ...
    @OnClick({R.id.tv_gwywj,R.id.tv_gwyzcbm})
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_gwyzcbm:
                type = 1;
                tv_gwywj.setTextColor(getResources().getColor(R.color.color_text));
                tv_gwyzcbm.setTextColor(getResources().getColor(R.color.blue));
                getData(1);
                break;
            case R.id.tv_gwywj:
                type = 0;
                tv_gwywj.setTextColor(getResources().getColor(R.color.blue));
                tv_gwyzcbm.setTextColor(getResources().getColor(R.color.color_text));
                getData(1);
                break;
