...
public class ldjhFregment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {
...
//                getData(pageNum);
        ...
        mRecyclerView.setAdapter(detailAdapter = new ldjhAdapter(beanList, mContext));
